                        ...
                        <div data-slide-toshow="4" class="cat-wrapper-02 main-slider col-md-8">
                            <div class="item">
                                <div class="cat-icons">
                                    ...
                                    <h5 class="cat-title">Mùa xuân</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="cat-icons">
                                    <i class="icons swin-icon-fish"></i>
                                    <h5 class="cat-title">Mùa hạ</h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="cat-icons">
                                    <i class="icons swin-icon-meat"></i>
                                </div>
                                <h5 class="cat-title">Mùa thu</h5>
                            </div>
                            <div class="item">
                                <div class="cat-icons">
                                    <i class="icons swin-icon-ice-cream"></i>
                                </div>
                                <h5 class="cat-title">Mùa đông</h5>
                            </div>
                        ...
                        <div class="row slick-padding">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="chi-tiet-mon-an.html">X Mexico Beafsteak Potato fly</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="chi-tiet-mon-an.html">Mexico Beafsteak Potato</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">Madagasca Lopster Tasty</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">Jambon Salad Hot Bread</a>
                                        </h5>
                                        <div class="product-info">
                                            <ul class="list-inline">
                                                <li class="author">
                                                    <span>Chef</span>
                                                    <span class="text">Don Joe</span>
                                                </li>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo
                                                consequat.
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">Mexico Beafsteak Potato</a>
                                        </h5>
                                        <div class="product-info">
                                            <ul class="list-inline">
                                                <li class="author">
                        ...
                        <div class="row slick-padding">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">H Mexico Beafsteak Potato fly</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
                        ...
                        <div class="row slick-padding">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">T Mexico Beafsteak Potato fly</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
                        ...
                        <div class="row slick-padding">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="blog-item item swin-transition">
                                    ...
                                    <div class="block-content">
                                        <h5 class="title">
                                            <a href="javascript:void(0)">Đ Mexico Beafsteak Potato fly</a>
                                        </h5>
                                        <div class="product-info">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo consequat.
